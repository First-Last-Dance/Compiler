...
function : 
    datatype IDENTIFIER ORBRACKET argument_list ERBRACKET OBRACE statement_list EBRACE      {printf("Define function\n");}
    ;
...
brace_scope: 
    OBRACE statement_list EBRACE								{printf("Block of statements\n");}
    | OBRACE EBRACE	
    ;

switch_scope:  
    OBRACE case_expression EBRACE					    {printf("Switch case block\n");}		
    ;
